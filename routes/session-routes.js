...
module.exports = function(app){
    ...
    app.get('/user/:participantId/sessions/participating', /*auth.userAccess,*/ function(req,res){
        sessionController.getSessionsByParticipant(req,res);
    });

    app.get('/user/:inviteeId/sessions/invited', /*auth.userAccess,*/ function(req,res){
